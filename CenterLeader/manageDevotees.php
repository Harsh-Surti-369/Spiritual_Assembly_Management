...
<body>
    <div class="container">
        ...
        // Query to retrieve the center ID of the center leader
        ...
        if ($center_result->num_rows > 0) {
            ...
            // Query to retrieve the list of devotees for the center leader's center
            ...
            if ($devotee_result->num_rows > 0) {
                ...
                while ($devotee_row = $devotee_result->fetch_assoc()) {
                    ...
                    echo "<td><a href='updateDevotee.php?devotee_id=" . $devotee_row["devotee_id"] . "'class='btn btn-primary'>Update</a>
                            <a href='#' class='btn btn-danger btn-delete' data-devotee-id='" . $devotee_row["devotee_id"] . "'>Delete</a></td></tr>";
                }
                echo "</tbody></table>";
                echo "</div>";
            } else {
