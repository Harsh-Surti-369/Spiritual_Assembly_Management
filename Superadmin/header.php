    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="index.php" style="color: #EFECEC;">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="centers.php" style="color: #EFECEC;">Centers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="devotees.php" style="color: #EFECEC;">Devotees</a>
                </li>
                <li class="nav-item">
